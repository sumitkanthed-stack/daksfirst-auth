...
async function persistCheck({ result, product, refs = {} }) {
  ...
  const r = await pool.query(
    `INSERT INTO credit_checks (
       ...
       result_status, result_grade, result_credit_score, result_recommended_limit_pence,
    ...
    [
      ...
      flat.result_credit_score ?? null,
      flat.result_recommended_limit_pence ?? null,
  ...
  try {
    ...
    if (includeBusiness && (parent.company_number || parent.company_name)) {
      ...
      summary.business = {
        ...
        score: r.success ? r.data?.result_credit_score : null,
