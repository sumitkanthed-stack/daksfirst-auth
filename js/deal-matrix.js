...
export async function renderDealMatrix(deal) {
  ...
  // ═══════════════════════════════════════════════════════════════════
  // SECTION 8: DOCUMENTS ISSUED — REMOVED
  // Now rendered as a standalone panel above tabs (documents-issued.js)
  // ═══════════════════════════════════════════════════════════════════

  // ═══════════════════════════════════════════════════════════════════
  // DOCUMENT REPOSITORY — REMOVED
  // Upload functionality lives in the Parser section above.
  // Issued docs now in the Documents Issued panel above tabs.
  // ═══════════════════════════════════════════════════════════════════
